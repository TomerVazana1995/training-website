        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm">
              ...
              Aspernatur in maxime quia adipisci error cum quod officia!
              Voluptatum est inventore voluptatibus eaque soluta, iusto ipsa
              dolore minima suscipit nemo quis?
            </p>
          </motion.div>
